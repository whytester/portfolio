...
A recent example of block development can be viewed at the top of [this event page](https://leaddev.com/leaddev-london/).  The animated header block was created so the client could use the library provided by https://www.finisher.co/lab/header/ while still able to use standard inner child elements overlaying the canvas animation generated by finisher.co.
